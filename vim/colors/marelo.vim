...
hi! link mustacheMarker Identifier
hi! link mustacheVariable Normal
hi! link mustacheSection Keyword

hi! PreProc gui=bold
hi! Type gui=bold

hi! ShowMarksHLl guifg=white guibg=NONE
hi! ShowMarksHLu guifg=white guibg=NONE
hi! ShowMarksHLo guifg=white guibg=NONE
hi! ShowMarksHLm guifg=yellow guibg=NONE
