...
about each one, use:
```bash
sh -c "`curl -fsSL https://raw.github.com/lfilho/dotfiles/master/install.sh`" -s ask
```
...
[Learn more about YADR's pry customizations and how to install](https://github.com/lfilho/dotfiles/blob/master/README-pry.md)
